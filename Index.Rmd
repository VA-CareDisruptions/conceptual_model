...
t <- 365*100  #100 year simulation period


#Main transitions..cumulative probabilities over a 2 year period. calculate daily prob as 
#1 - exp(log(1-cum_prob)/t)

cum_P_3_4=0.56 #Prob going from in control to out of control with infrequent monitoring

cum_P_1_2 = P_3_4*(1/1.10) #Prob going from in control to out of control with frequent monitoring

cum_P_2_1 = 0.21 #Prob going from out of control to in control with frequent monitoring

cum_P_4_3 = P_2_1*0.8  #Prob going from out of control to in control with infrequent monitoring

cum_P_1_3 = 0.3 #Prob of in control frequent monitoring to in control infrequent monitoring

cum_P_3_1 = 0.2 #Prob of in control infrequent monitoring to in control frequent monitoring
